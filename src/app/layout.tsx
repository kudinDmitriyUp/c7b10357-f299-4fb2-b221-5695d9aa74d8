...
export const metadata: Metadata = {
  title: "Premium Chiropractic Care | ProAlign Clinic",
  description: "Expert chiropractors in your area. Spinal adjustments, pain relief, and wellness care from licensed professionals. Schedule your consultation today.",
  keywords: "chiropractor, chiropractic care, spinal adjustment, back pain relief, wellness, health",
  metadataBase: new URL("https://proalign-chiropractic.com"),
  alternates: {
    canonical: "https://proalign-chiropractic.com"
  },
  openGraph: {
    title: "Premium Chiropractic Care | ProAlign Clinic",
    description: "Expert chiropractic treatment from licensed professionals. Spinal health, pain relief, and personalized wellness plans.",
    url: "https://proalign-chiropractic.com",
    siteName: "ProAlign Chiropractic",
    type: "website",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1765552062112-wf28b80z.jpg",
        alt: "ProAlign Chiropractic Premium Care"
      }
    ]
  },
  twitter: {
    ...
    title: "Premium Chiropractic Care | ProAlign Clinic",
    description: "Expert chiropractors providing spinal health and pain relief solutions.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1765552062112-wf28b80z.jpg"]
  },
  robots: {
    index: true,
    follow: true
